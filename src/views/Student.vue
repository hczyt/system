  ...
  <el-dialog :title="dialogTitle"  :visible.sync="dialogFormVisible" size="mini"   v-show="dialogFormVisible" class="transition-box">
    <el-form :inline="true" :model="addstudent" class="demo-form-inline" size="mini" >
      ...
      <el-form-item label="年龄:" >
        <el-input v-model="addstudent.old" placeholder="18"></el-input>
      </el-form-item>
      <el-form-item label="地址:" >
        <el-input v-model="addstudent.address" placeholder="xxx省xxx市xxx区xxxx"></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
      ...
      <el-form :inline="true" :model="xstudent" class="demo-form-inline" size="mini" ref="xstudent" style="width:100%">
        <el-form-item label="学号" prop="snumber" 
            :rules="[
